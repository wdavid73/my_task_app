...
class DarkTheme {
  ...
  static ThemeData getDarkTheme(BuildContext context) {
    ...
    return ThemeData(
      ...
      textButtonTheme: getBaseTextButtonDarkTheme(
        fontSizeFactor: fontSizeFactor,
      ),
      outlinedButtonTheme: getBaseOutlinedButtonDarkTheme(
        fontSizeFactor: fontSizeFactor,
      ),
      ...
      listTileTheme: _baseListTileTheme.copyWith(
        ...
        subtitleTextStyle: baseTextThemeDark.labelSmall?.copyWith(fontSize: 10),
      ),
      ...
      navigationDrawerTheme: _baseNavigationDrawer.copyWith(
        ...
        labelTextStyle: _resolveTextStyleWith(
          baseTextThemeDark.labelLarge!.copyWith(color: ColorTheme.textPrimary),
          baseTextThemeDark.labelLarge!.copyWith(
            color: ColorTheme.lightPrimaryColor,
          ),
        ),
      ),
      popupMenuTheme: _basePopupMenuThemeData.copyWith(iconSize: context.dp(3)),
    );
  }
}
