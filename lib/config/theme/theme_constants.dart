...
import 'package:my_tasks_app/config/theme/widget_themes/text_theme.dart';
...
class ThemeConstants {
  ...
  static final baseDividerTheme = DividerThemeData(color: ColorTheme.divider);
  ...
  static final baseDrawerTheme = DrawerThemeData(
    scrimColor: ColorTheme.backgroundColorDark.withValues(alpha: 0.5),
    endShape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
  );
  ...
  static final baseProgressIndicatorTheme = const ProgressIndicatorThemeData();
  ...
  static final baseBottomSheetTheme = BottomSheetThemeData(
    ...
    constraints: const BoxConstraints(minHeight: 250, minWidth: 450),
  );
  ...
  static final baseSwitchTheme = SwitchThemeData(
    ...
    thumbColor: resolveColorWith(ColorTheme.white, ColorTheme.disable),
    trackColor: resolveColorWith(ColorTheme.secondaryColor, ColorTheme.white),
  );
  ...
  static final baseRadioTheme = RadioThemeData(
    fillColor: WidgetStatePropertyAll<Color>(ColorTheme.secondaryColor),
  );
  ...
  static final baseCheckboxTheme = CheckboxThemeData(
    fillColor: resolveColorWith(ColorTheme.secondaryColor, ColorTheme.white),
    checkColor: resolveColorWith(ColorTheme.white, Colors.transparent),
  ...
  static final baseNavigationRail = NavigationRailThemeData(
    ...
    minWidth: 50,
    selectedIconTheme: baseIconTheme.copyWith(color: ColorTheme.accentColor),
